 ...
 * path, message id, optional expand id). The Summary blockquote — which
 * requires LLM judgment — stays agent-driven; pass `summary` (string) to embed
 * it, or omit/leave null to emit a `{{SUMMARY_PLACEHOLDER}}` marker the agent
 * should replace before forwarding to the user.
 *
